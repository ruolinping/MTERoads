...
namespace MTERoads.Models
{
    ...
    public partial class RoadsEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetAllRoadsWithType_Result> GetAllRoadsWithType()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllRoadsWithType_Result>("GetAllRoadsWithType");
        }
    
        public virtual ObjectResult<GetAllTrans_Result> GetAllTrans()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllTrans_Result>("GetAllTrans");
        }
    }
}
